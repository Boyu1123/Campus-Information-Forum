...
public class PushService extends Service {
	...
	private static final String MQTT_HOST = NumberValue.IPURL;
	...
	// Notification title
	public static String NOTIF_TITLE = "xxxxxxxxx00";
	// Notification id
...
//					setStarted(true);
	...
	private void showNotification(String text, String type) {
		...
		if ("clothe".equals(type)) {
			NOTIF_TITLE = "女装 4锟斤拷锟斤拷锟斤拷锟疥即止";
		}
		if ("phone".equals(type)) {
			NOTIF_TITLE = "锟街伙拷 9锟斤拷锟斤拷锟斤拷锟疥即止";
		}
...
//		n.setLatestEventInfo(this, NOTIF_TITLE, text, pi);
	...
	private class MQTTConnection implements MqttSimpleCallback {
		...
		public void publishArrived(String topicName, byte[] payload, int qos,
			...
			String s = "{}";
			try {
				s = new String(payload,"GBK");
			} catch (UnsupportedEncodingException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			JSONObject dataJSON = JSONObject.fromString(s);
...
//			Log.d("test", "1111");
			//鍙戦�骞挎挱
			Intent intent = new Intent(NewChatActivity.ACTION_MSG);
