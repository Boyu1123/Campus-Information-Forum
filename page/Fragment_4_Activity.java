...
public class Fragment_4_Activity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.fragment_4_activity);
		init();
	}
	...
	private void init() {
		...
		listView = (ListView) findViewById(R.id.f4_activity_listview);
	...
	private void getMyActivity() {
		...
		params.put("type", "getMyActivity");
		int userid = app.getUser().getId();
		params.put("userid", String.valueOf(userid));
		HttpServer.setPostRequest(params, new ActivityParser(),
				URLConstants.BASEURL + URLConstants.ACTIVITYURL, new Callback() {
						...
						if (activityData.getCode() == StatusCode.Common.SUCCESS) {
							if (activityData.getFlag() == StatusCode.Dao.SELECT_SUCCESS) {
								...
								ActivityListViewAdapter adapter = new ActivityListViewAdapter(
										Fragment_4_Activity.this, list);
								listView.setAdapter(adapter);
							} else {
								ExampleUtil.showToast("获取信息失败，请重试",
										Fragment_4_Activity.this);
							}
						} else {
					...
					public void fail(String error) {
						ExampleUtil.showToast(error, Fragment_4_Activity.this);
	...
	private OnItemClickListener listener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
			...
			Intent intent = new Intent(Fragment_4_Activity.this,
					More_ActivityPersonal.class);
