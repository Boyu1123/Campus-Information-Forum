...
public class Fragment_2 extends Fragment implements OnClickListener {
	...
	private Fragment_2_2 fragment_2_2;

	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		View view = inflater.from(getActivity()).inflate(R.layout.fragment_2,
				null);
		init(view);
		return view;
	}
	...
	private void init(View view) {
		...
		fragment_2_2 = new Fragment_2_2();
		list.add(new Fragment_2_1());
		list.add(fragment_2_2);
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		fragment_2_2.onActivityResult(requestCode, resultCode, data);
	}
}
