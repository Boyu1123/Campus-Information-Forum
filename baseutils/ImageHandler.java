package com.ustb.baseutils;

import java.lang.ref.WeakReference;

import com.ustb.page.Fragment_1_1;
...
public class ImageHandler extends Handler {
	...
	public ImageHandler(WeakReference<Fragment> wk) {
		weakReference = wk;
	}
	...
	public void handleMessage(Message msg) {
		...
		Fragment_1_1 activity = (Fragment_1_1) weakReference.get();
		if (activity == null) {
