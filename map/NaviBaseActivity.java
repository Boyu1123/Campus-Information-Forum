...
import com.ustb.map.util.ErrorInfo;
import com.ustb.map.util.TTSController;

import java.util.ArrayList;
import java.util.List;

public class NaviBaseActivity extends Activity implements AMapNaviListener,
		AMapNaviViewListener {

	protected AMapNaviView mAMapNaviView;
	protected AMapNavi mAMapNavi;
	protected TTSController mTtsManager;
//	protected NaviLatLng mEndLatlng = new NaviLatLng(40.212627, 116.23843);
...
//		eList.add(mEndLatlng);
	...
	public void onCalculateRouteFailure(int errorInfo) {
		...
		Log.e("test", "--------------------------------------------");
		Log.i("test",
				"路线计算失败：错误码=" + errorInfo + ",Error Message= "
		...
		Toast.makeText(
				...
				"errorInfo：" + errorInfo + ",Message："
						+ ErrorInfo.getError(errorInfo), Toast.LENGTH_LONG)
				.show();
	}
