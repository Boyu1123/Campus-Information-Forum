...
public class FriendListViewAdapter extends BaseAdapter {
	...
	public FriendListViewAdapter(Context context, ArrayList<E_Friend> list) {
		super();
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		final ViewHolder vh;
		if (arg1 == null) {
			arg1 = LayoutInflater.from(context).inflate(R.layout.item_friendlist,
					null);
			vh = new ViewHolder();
			vh.t_name = (TextView) arg1.findViewById(R.id.friend_name);
			vh.t_info = (TextView) arg1.findViewById(R.id.friend_info);
			vh.i_head = (ImageView) arg1.findViewById(R.id.friend_img);
			arg1.setTag(vh);
		} else {
			vh = (ViewHolder) arg1.getTag();
		}
		vh.t_name.setText(list.get(arg0).getFriendname());
		vh.t_info.setText(list.get(arg0).getFriendinfo());
		vh.i_head.setImageResource(R.drawable.head01);

		ImageUtils.getBitmapUtils(context).display(vh.i_head,
				URLConstants.BASEURL + list.get(arg0).getFriendhead(),
