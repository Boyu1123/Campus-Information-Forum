...
public class F21ListViewAdapter extends BaseAdapter {
	private Context context;
	private ArrayList<E_Card> list;

	public F21ListViewAdapter(Context context, ArrayList<E_Card> list) {
		super();
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		vh.t_title.setText(list.get(arg0).getCardtitle());
		vh.t_mess.setText(list.get(arg0).getCardmess());
